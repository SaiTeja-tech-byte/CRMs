...
const mapUserToTeamMember = (u) => {
  ...
  return {
    ...
    joiningDate: u.createdAt ? u.createdAt.slice(0, 10) : "",
    status: u.employmentStatus === "Active" ? "Online" : "Offline",
    profileImage: u.avatarUrl || "",
  };
};

// ----------------------------------------------------
// Mock Datasets (Static elements)
// ----------------------------------------------------
const initialTasks = [];

const mockNotifications = [
  { id: 1, text: "Contract signed by Stark Corp", time: "5 mins ago", icon: "bi-file-earmark-check", color: "text-success" },
  { id: 2, text: "Payment received from Google", time: "30 mins ago", icon: "bi-wallet2", color: "text-success" },
  { id: 3, text: "Lead assigned: Amazon Web Services", time: "1 hour ago", icon: "bi-person-badge", color: "text-info" }
];
  ...
  return (
    <div style={{ height: "240px", width: "100%", position: "relative", padding: "10px 0", display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div className="text-center text-muted" style={{ padding: "40px" }}>
        <i className="bi bi-graph-up-arrow text-secondary mb-3" style={{ fontSize: "36px", display: "block" }}></i>
        <h5 style={{ fontSize: "13px", fontWeight: "750", color: "var(--crm-dark)", margin: "0 0 6px 0" }}>No Sales Data Available</h5>
        <p style={{ fontSize: "11.5px", maxWidth: "280px", margin: "0 auto" }}>Create custom customer deals or log transactions to view sales revenue curves.</p>
      </div>
    </div>
  );
};
    ...
    <div className="dashboard-card-flat">
          ...
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
              <div style={{
                ...
                <i className="bi bi-trash3-fill" style={{ color: "#ef4444", fontSize: "16px" }}></i>
              </div>
              <h4 style={{ margin: 0, fontSize: "15px", fontWeight: "800", color: "#0f172a" }}>Delete Account</h4>
            </div>
            <p style={{ fontSize: "13px", color: "#475569", marginBottom: "6px" }}>
              Are you sure you want to permanently delete your account?
            </p>
            <p style={{ fontSize: "12px", color: "#ef4444", fontWeight: "600", marginBottom: "20px" }}>
      ...
      {(!profile.firstName || profile.firstName.trim() === "") && (
        <div className="alert alert-info border-0 rounded-3 mb-4 d-flex align-items-center gap-2" style={{ background: "#eff6ff", color: "#2563eb", padding: "16px" }}>
          ...
          <span style={{ fontSize: "12px", fontWeight: "700" }}>Complete your profile to personalize your CRM workspace.</span>
        </div>
      )}
        ...
        <div className="row g-4">
          ...
          <div className="col-12">
            <div className="p-3 border rounded-3 bg-light text-center d-flex flex-column align-items-center gap-3">
              <h5 className="mb-0 text-muted" style={{ fontSize: "11.5px", fontWeight: "755", textTransform: "uppercase" }}>Profile Photo</h5>
              <AvatarRenderer profile={formData} size={100} />
              <div className="d-flex gap-2">
                <label className="btn-profile-primary" style={{ cursor: "pointer", fontSize: "11.5px", padding: "6px 16px" }}>
                  Upload Image
                  <input type="file" accept="image/png, image/jpeg, image/jpg" style={{ display: "none" }} onChange={handleFileChange} />
                </label>
                {formData.avatar && (
                  <button type="button" className="btn-profile-secondary" style={{ fontSize: "11.5px", padding: "6px 16px" }} onClick={handleRemovePhoto}>
                    Remove
                  </button>
                )}
              </div>
          ...
          <div className="col-12">
            <div className="p-3 border rounded-3">
              <h4 className="mb-3" style={{ fontSize: "13px", fontWeight: "800", color: "var(--crm-primary)" }}>Personal Information</h4>
          ...
          <div className="col-12">
            <div className="p-3 border rounded-3">
              <h4 className="mb-3" style={{ fontSize: "13px", fontWeight: "800", color: "var(--crm-primary)" }}>Contact Information</h4>
              <div className="row g-3">
          ...
          <div className="col-12">
            <div className="p-3 border rounded-3">
              <h4 className="mb-3" style={{ fontSize: "13px", fontWeight: "800", color: "var(--crm-primary)" }}>Professional Information</h4>
              <div className="row g-3">
  ...
  return (
    <div className="dashboard-card-flat">
      <div className="card-flat-title-bar">
        ...
        <span className="text-muted" style={{ fontSize: "11.5px", fontWeight: "700" }}>Manage application preferences</span>
      </div>
        ...
        <div className="row g-4">
          <div className="col-12">
            <div className="p-3 border rounded-3 bg-light">
              <h4 className="mb-3" style={{ fontSize: "13px", fontWeight: "800", color: "var(--crm-primary)" }}>Preferences</h4>
              <div className="row g-3">
                <div className="col-md-4 modal-form-group">
                  <label>Theme</label>
                ...
                <div className="col-md-6">
                  <div className="form-check">
                    ...
                    <label className="form-check-label" htmlFor="setNotifEmail" style={{ fontSize: "11.5px", fontWeight: "600" }}>Enable Email Alerts</label>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="form-check">
                    ...
                    <label className="form-check-label" htmlFor="setNotifPush" style={{ fontSize: "11.5px", fontWeight: "600" }}>Enable Push Notifications</label>
                  </div>
                </div>
              </div>
            </div>
...
const CalendarPage = ({ events, onAddEvent, onUpdateEvent, onDeleteEvent, profile }) => {
  ...
  const [newEventForm, setNewEventForm] = useState({
    ...
    priority: "Medium",
    status: "Pending",
    assignedTo: profile?.firstName ? `${profile.firstName} ${profile.lastName}` : "Pilli Keshav Rao",
    location: ""
  });
  ...
  return (
    <div className="dashboard-card-flat">
      ...
      <div className="d-flex justify-content-between align-items-center flex-wrap gap-3 mb-4 pb-3 border-bottom">
        <div>
          <h3 className="mb-1" style={{ fontSize: "14px", fontWeight: "800", textTransform: "uppercase", color: "var(--crm-dark)", letterSpacing: "0.02em" }}>
            Calendar
          </h3>
        ...
        <div className="d-flex align-items-center gap-2 flex-wrap">
          ...
          <select 
            ...
            style={{ width: "130px", fontSize: "11.5px", height: "36px", border: "1px solid var(--crm-border)" }}
            value={filterType}
      ...
      <div className="calendar-layout-wrapper">
        ...
        <div className="calendar-right-side">
              ...
              {upcomingList.length > 0 ? (
                ...
                <div className="text-center py-3">
                  ...
                  <button 
                    ...
                    style={{ fontSize: "11px" }}
                    onClick={() => { setNewEventForm(prev => ({ ...prev, date: "2026-07-15" })); setShowAddModal(true); }}
                  >
                    Create Event
                  </button>
                </div>
          ...
          <div className="p-3 border rounded-3 bg-light">
            ...
            <div className="d-flex flex-column gap-2">
              <button type="button" className="btn-profile-secondary text-start py-1.5 px-3" style={{ fontSize: "11.5px", fontWeight: "700" }} onClick={() => triggerQuickAdd("Meeting")}>
                <i className="bi bi-people text-primary me-2"></i> Create Meeting
              </button>
              <button type="button" className="btn-profile-secondary text-start py-1.5 px-3" style={{ fontSize: "11.5px", fontWeight: "700" }} onClick={() => triggerQuickAdd("Reminder")}>
                <i className="bi bi-bell text-warning me-2"></i> Create Reminder
              </button>
              <button type="button" className="btn-profile-secondary text-start py-1.5 px-3" style={{ fontSize: "11.5px", fontWeight: "700" }} onClick={() => triggerQuickAdd("Follow-up")}>
          ...
          <div className="dashboard-card-flat" style={{ width: "450px", maxWidth: "90%" }}>
            ...
            <div className="d-flex flex-column gap-3 py-2">
              <div>
                ...
                <strong style={{ fontSize: "14px", color: "var(--crm-dark)" }}>{activeEvent.title}</strong>
              </div>

              <div>
                <span className="text-muted d-block" style={{ fontSize: "10.5px", fontWeight: "700" }}>DESCRIPTION</span>
                <p className="mb-0" style={{ fontSize: "11.5px", color: "#475569" }}>{activeEvent.description || "No description provided."}</p>
              </div>

              <div className="row g-2">
                <div className="col-6">
                  <span className="text-muted d-block" style={{ fontSize: "10.5px", fontWeight: "700" }}>DATE</span>
                  <span style={{ fontSize: "12px", fontWeight: "600" }}>{activeEvent.date}</span>
                </div>
                <div className="col-6">
                  <span className="text-muted d-block" style={{ fontSize: "10.5px", fontWeight: "700" }}>TIME</span>
                  <span style={{ fontSize: "12px", fontWeight: "600" }}>{activeEvent.startTime} - {activeEvent.endTime}</span>
                </div>
                <div className="col-6 mt-2">
                  <span className="text-muted d-block" style={{ fontSize: "10.5px", fontWeight: "700" }}>ASSIGN TO</span>
                  <span style={{ fontSize: "12px", fontWeight: "600" }}>{activeEvent.assignedTo || "Unassigned"}</span>
                </div>
                <div className="col-6 mt-2">
                  <span className="text-muted d-block" style={{ fontSize: "10.5px", fontWeight: "700" }}>LOCATION</span>
                  <span style={{ fontSize: "12px", fontWeight: "600" }}>{activeEvent.location || "None"}</span>
                </div>
                <div className="col-6 mt-2">
                  <span className="text-muted d-block" style={{ fontSize: "10.5px", fontWeight: "700" }}>CUSTOMER</span>
                  <span style={{ fontSize: "12px", fontWeight: "600" }}>{activeEvent.customer || "Internal"}</span>
                </div>
      ...
      {showDeleteConfirm && activeEvent && (
        <div style={{
          ...
          <div className="dashboard-card-flat" style={{ width: "350px", maxWidth: "90%" }}>
            <h4 style={{ fontSize: "13px", fontWeight: "800", color: "#ef4444", marginBottom: "14px" }}>
              Delete this event?
            </h4>
            <p style={{ fontSize: "11.5px", color: "#64748b" }}>Are you sure you want to permanently delete event "<strong>{activeEvent.title}</strong>"?</p>
...
const TasksPage = ({ tasks, onAddTask, onUpdateTask, onDeleteTask, profile }) => {
  ...
  const [newTaskForm, setNewTaskForm] = useState({
    ...
    dueDate: TODAY_STR,
    dueTime: "12:00 PM",
    assignedTo: profile?.displayName || "Pilli Keshav Rao",
    category: "Sales",
    status: "Pending",
    notes: ""
  });
  ...
  const overdueCount = (tasks || []).filter(t => t.dueDate < TODAY_STR && t.status !== "Completed").length;
  const newCount = (tasks || []).filter(t => t.status === "Pending").length;
  const dueTodayCount = (tasks || []).filter(t => t.dueDate === TODAY_STR && t.status !== "Completed").length;
  const upcomingCount = (tasks || []).filter(t => t.dueDate > TODAY_STR && t.status !== "Completed").length;
  ...
  const getCategoryTasks = () => {
    switch (activeCategory) {
      ...
      case "Overdue":
        return (tasks || []).filter(t => t.dueDate < TODAY_STR && t.status !== "Completed");
      case "New":
  ...
  const finalTasks = categoryTasks.filter(t => {
    ...
    if (dateFilter === "Today") {
      matchesDate = t.dueDate === TODAY_STR;
    } else if (dateFilter === "This Week") {
      matchesDate = t.dueDate >= "2026-07-12" && t.dueDate <= "2026-07-18";
    } else if (dateFilter === "This Month") {
      matchesDate = (t.dueDate || "").startsWith("2026-07-");
    }
  ...
  const formatTaskDueDateText = (dateStr) => {
    ...
    if (dateStr === "2026-07-16") return "Thursday";
    if (dateStr === "2026-07-17") return "Friday";
    ...
    <div className="dashboard-card-flat">
      ...
      <div className="tasks-layout-wrapper">
        ...
        <div className="tasks-right-content">
          <div className="tasks-toolbar" style={{ display: "flex", gap: "10px", marginBottom: "14px", flexWrap: "wrap" }}>
            ...
            <select className="form-select w-auto" style={{ borderRadius: "8px" }} value={priorityFilter} onChange={(e) => setPriorityFilter(e.target.value)}>
          ...
          {finalTasks.length === 0 ? (
            <div className="empty-state-card">
              ...
              <h4 style={{ fontSize: "13px", fontWeight: "800", color: "var(--crm-dark)", margin: "0 0 6px 0" }}>No Tasks Found</h4>
            ...
            <div className="d-flex flex-column gap-2">
              {paginatedTasks.map(task => (
                <div
                  ...
                  onClick={() => { setSelectedTask(task); setShowDetailsDrawer(true); }}
                  style={{ cursor: "pointer", display: "flex", alignItems: "center", gap: "12px", padding: "12px 14px", border: "1px solid var(--crm-border, #e5e7eb)", borderRadius: "10px", background: "#fff" }}
                >
                  <div
                    className={`task-row-checkbox ${task.status === "Completed" ? "completed" : ""}`}
                    onClick={(e) => handleToggleTaskStatus(task, e)}
                    style={{ width: "20px", height: "20px", borderRadius: "6px", border: "2px solid #cbd5e1", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, background: task.status === "Completed" ? "var(--crm-primary, #2563eb)" : "transparent", borderColor: task.status === "Completed" ? "var(--crm-primary, #2563eb)" : "#cbd5e1" }}
                  >
                    {task.status === "Completed" && <i className="bi bi-check text-white"></i>}
                  </div>
                  <div className="flex-grow-1" style={{ minWidth: 0 }}>
                    ...
                    <div className="text-muted text-truncate" style={{ fontSize: "11.5px" }}>
                      {task.createdBy && task.createdBy !== (profile?.displayName)
                        ? `Assigned by ${task.createdBy} · `
                        : ""}
                      {task.dueDate ? formatTaskDueDateText(task.dueDate) : "No due date"}
                    </div>
                  </div>
                  <span className={`badge-priority ${(task.priority || "Medium").toLowerCase()}`} style={{ fontSize: "8.5px", flexShrink: 0 }}>
          ...
          <div style={{
            ...
            <div className="d-flex flex-column gap-3 flex-grow-1 overflow-y-auto" style={{ paddingRight: "4px" }}>
              <div>
                ...
                <strong style={{ fontSize: "14px", color: "var(--crm-dark)" }}>{selectedTask.title}</strong>
              </div>

              <div>
                <span className="text-muted d-block" style={{ fontSize: "10px", fontWeight: "700" }}>DESCRIPTION</span>
                <p className="mb-0" style={{ fontSize: "11.5px", color: "#475569", lineHeight: "1.4" }}>{selectedTask.description || "No description provided."}</p>
              </div>

              <div className="row g-3">
                <div className="col-6">
                  <span className="text-muted d-block" style={{ fontSize: "10px", fontWeight: "700" }}>ASSIGNED BY</span>
                  <span style={{ fontSize: "11.5px", fontWeight: "600" }}>{selectedTask.createdBy || "System"}</span>
                </div>
                <div className="col-6">
                  <span className="text-muted d-block" style={{ fontSize: "10px", fontWeight: "700" }}>ASSIGNED TO</span>
                  <span style={{ fontSize: "11.5px", fontWeight: "600" }}>{selectedTask.assignedTo || "Unassigned"}</span>
                </div>
                <div className="col-6">
                  <span className="text-muted d-block" style={{ fontSize: "10px", fontWeight: "700" }}>DUE DATE</span>
                  <span style={{ fontSize: "11.5px", fontWeight: "600" }}>{selectedTask.dueDate}</span>
                </div>
                <div className="col-6">
                  <span className="text-muted d-block" style={{ fontSize: "10px", fontWeight: "700" }}>DUE TIME</span>
                  <span style={{ fontSize: "11.5px", fontWeight: "600" }}>{selectedTask.dueTime || "None"}</span>
                </div>
                <div className="col-6">
  ...
  return (
    <div className="dashboard-card-flat">
      ...
      <div className="mb-4 pb-3 border-bottom">
        <h3 className="mb-0" style={{ fontSize: "14px", fontWeight: "800", textTransform: "uppercase", color: "var(--crm-dark)", letterSpacing: "0.02em" }}>
          Team Management
        </h3>
      </div>
          ...
          <div className="col-6 col-md-3" key={idx}>
            <div className="p-3 border rounded-3 bg-light text-center h-100 d-flex flex-column justify-content-center">
              ...
              <div className="d-flex align-items-center justify-content-center gap-2">
                <i className={`bi ${stat.icon}`} style={{ color: stat.color, fontSize: "16px" }}></i>
                <strong style={{ fontSize: "18px", color: "var(--crm-dark)" }}>{stat.val}</strong>
              </div>
            </div>
          </div>
        ))}
        ...
        <div className="team-right-content">
          ...
          {filteredMembers.length > 0 ? (
            ...
            <div className="empty-state-card py-5">
              ...
              <h4 style={{ fontSize: "14px", fontWeight: "800", color: "var(--crm-dark)", margin: "0 0 8px 0" }}>No Team Members Found</h4>
              <p className="text-muted mb-0" style={{ fontSize: "11.5px" }}>
            ...
            <div className="d-flex flex-column gap-3 flex-grow-1 overflow-y-auto" style={{ paddingRight: "4px" }}>
              <div className="text-center pb-3 border-bottom">
                {selectedMember.profileImage ? (
                  ...
                  <div className="member-card-initials mx-auto" style={{ width: "90px", height: "90px", fontSize: "28px" }}>
                    {`${selectedMember.firstName?.[0] || ""}${selectedMember.lastName?.[0] || ""}`.toUpperCase()}
                  </div>
                )}
                <h4 style={{ fontSize: "14px", fontWeight: "800", margin: "10px 0 2px 0" }}>{selectedMember.firstName} {selectedMember.lastName}</h4>
                <span className="badge bg-primary-subtle text-primary" style={{ fontSize: "11px", fontWeight: "700" }}>{selectedMember.designation}</span>
              </div>

              <div className="row g-3" style={{ fontSize: "11.5px" }}>
                <div className="col-6">
...
const NotificationsPage = ({ notifications, onMarkAllRead, onUpdateNotification, onDeleteNotification, setActiveMenu }) => {
  ...
  const getNotifIcon = (type) => {
    switch (type) {
      ...
      case "CRM AI Suggestion":
        return "bi-stars text-primary";
      default:
  ...
  const todayCount = (notifications || []).filter(n => n.date === TODAY_STR && !n.archived).length;
      ...
      <div className="notif-layout-wrapper">
        ...
        <div className="notif-side-summary">
          <div className="p-3 border rounded-3 bg-light">
            ...
            <div className="d-flex flex-column gap-3" style={{ fontSize: "11.5px" }}>
...
const DocumentsPage = ({ documents, onUpload, onCreateFolder, onDelete, onUpdate, profile }) => {
  ...
  const handleUploadSubmit = (e) => {
    ...
    onUpload({
      ...
      uploadedBy: profile.firstName ? `${profile.firstName} ${profile.lastName}` : "Pilli Keshav Rao",
      size: `${uploadForm.sizeVal} MB`,
      sizeBytes: uploadForm.sizeVal * 1024 * 1024,
      lastModified: TODAY_STR,
    ...
    <div className="dashboard-card-flat">
      ...
      <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
        <div className="d-flex flex-wrap align-items-center gap-2">
          ...
          <select className="form-select py-1 px-3" style={{ width: "130px", fontSize: "11.5px", height: "36px" }} value={catFilter} onChange={(e) => setCatFilter(e.target.value)}>
          ...
          <select className="form-select py-1 px-3" style={{ width: "130px", fontSize: "11.5px", height: "36px" }} value={deptFilter} onChange={(e) => setDeptFilter(e.target.value)}>
          ...
          <select className="form-select py-1 px-3" style={{ width: "120px", fontSize: "11.5px", height: "36px" }} value={typeFilter} onChange={(e) => setTypeFilter(e.target.value)}>
          ...
          <select className="form-select py-1 px-3" style={{ width: "110px", fontSize: "11.5px", height: "36px" }} value={statusFilter} onChange={(e) => setStatusFilter(e.target.value)}>
        ...
        <div className="d-flex align-items-center gap-2">
          <span className="text-muted" style={{ fontSize: "11.5px", fontWeight: "700" }}>Sort By:</span>
          <select className="form-select py-1 px-3" style={{ width: "120px", fontSize: "11.5px", height: "36px" }} value={sortBy} onChange={(e) => setSortBy(e.target.value)}>
      ...
      <div className="team-layout-wrapper">
        ...
        <div className="team-right-content">
          {sortedDocs.length > 0 ? (
                  ...
                  <tbody>
                    {paginatedDocs.map(doc => (
                      <tr key={doc.id}>
                        <td>
                          <div className="d-flex align-items-center gap-2">
                            <i className={`bi ${getFileIcon(doc)}`} style={{ fontSize: "16px" }}></i>
                        ...
                        <td className="text-end">
                          <div className="dropdown d-inline-block">
                            ...
                            <ul className="dropdown-menu dropdown-menu-end" style={{ fontSize: "11.5px" }}>
                              <li>
                                <button 
            ...
            <div className="empty-state-card py-5">
              <i className="bi bi-folder2-open empty-state-icon" style={{ fontSize: "48px" }}></i>
              <h4 style={{ fontSize: "14px", fontWeight: "800", color: "var(--crm-dark)", margin: "0 0 8px 0" }}>No Documents Found</h4>
              <p className="text-muted mb-0" style={{ fontSize: "11.5px" }}>
                  ...
                  <div className="d-flex gap-4">
                    {["Public", "Private", "Team Only"].map(vis => (
                      <div className="form-check" key={vis}>
                        ...
                        />
                        <label className="form-check-label" htmlFor={`vis-${vis}`} style={{ fontSize: "11.5px", fontWeight: "600" }}>{vis}</label>
                      </div>
                    ))}
                  </div>
                </div>
...
const NewsPage = () => {
  ...
  React.useEffect(() => {
    ...
    const interval = setInterval(() => fetchAnnouncements(false), 10000);
  ...
  return (
    <div className="dashboard-card-flat">
      {/* Header */}
      <div className="mb-4 pb-3 border-bottom">
        <h3 style={{ fontSize: "18px", fontWeight: "800", color: "var(--crm-dark)", margin: "0 0 4px", textTransform: "uppercase", letterSpacing: "0.04em" }}>
          NEWS
        </h3>
        <p className="text-muted mb-0" style={{ fontSize: "11.5px" }}>
      ...
      {!loading && (error || announcements.length === 0) && (
        <div className="empty-state-card py-5 text-center">
          ...
          <p className="text-muted mb-0" style={{ fontSize: "12px", maxWidth: "400px", margin: "0 auto" }}>There are currently no company announcements or news articles.</p>
          <button className="btn-profile-primary mt-4" style={{ padding: "8px 20px" }} onClick={fetchAnnouncements}><i className="bi bi-arrow-clockwise"></i> Try Again</button>
        </div>
      )}
        ...
        <div className="d-flex flex-column gap-3">
          {announcements.map((item) => (
            ...
            >
              ...
              {/* Title */}
              <h4 style={{ fontSize: "14px", fontWeight: "800", color: "#2563eb", margin: "0 0 8px" }}>
                {item.title}
              </h4>

              {/* Content */}
              <p style={{ fontSize: "12.5px", color: "#334155", lineHeight: "1.65", margin: 0, whiteSpace: "pre-line" }}>
                {item.content}
              </p>
            </div>
          ))}
...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setTasksError("Couldn't load tasks. Please refresh the page.");
      } finally {
 ...
 const headers = {
  ...
  Pragma: "no-cache",
    ...
    const base = (import.meta.env.VITE_API_URL || "http://localhost:5000/api/auth").replace("/auth", "");
    ...
    try {
      // 2. Sync Tasks
      const tasksRes = await fetch(`${base}/tasks`, { headers });
      if (tasksRes.ok) {
        const data = await tasksRes.json();
        if (data.success) {
          setTasks(data.tasks || []);
          localStorage.setItem("crm_tasks_v2", JSON.stringify(data.tasks || []));
        }
      }
    ...
    try {
      ...
      if (eventsRes.ok) {
        ...
        if (data.success) {
          ...
          localStorage.setItem("crm_events_v2", JSON.stringify(data.events || []));
        }
      }
    ...
    try {
      ...
      if (teamRes.ok) {
        ...
        if (data.success) {
          const mapped = (data.users || []).map(mapUserToTeamMember);
          setTeamMembers(mapped);
          localStorage.setItem("crm_team_members_v2", JSON.stringify(mapped));
        }
      }
    } catch (e) { console.error("Error syncing team:", e); }

    try {
      // 4. Sync Documents
      const docsRes = await fetch(`${base}/documents`, { headers });
      if (docsRes.ok) {
        const data = await docsRes.json();
        if (data.success) {
          setDocuments(data.documents || []);
          localStorage.setItem("crm_documents_v2", JSON.stringify(data.documents || []));
        }
      }
  ...
  React.useEffect(() => {
    connectSocket();
    const unsubscribers = [
      onSocketEvent("task:new", syncDashboardData),
      onSocketEvent("task:deleted", syncDashboardData),
      onSocketEvent("event:new", syncDashboardData),
      onSocketEvent("event:deleted", syncDashboardData),
      onSocketEvent("document:new", syncDashboardData),
      onSocketEvent("document:deleted", syncDashboardData),
      onSocketEvent("team:updated", syncDashboardData),
      onSocketEvent("profile:updated", syncDashboardData),
  ...
  const handleUpdateEvent = async (updatedEvent) => {
    ...
    const base = (import.meta.env.VITE_API_URL || "http://localhost:5000/api/auth").replace("/auth", "");
    try {
      await fetch(`${base}/events/${updatedEvent.id}`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
  ...
  const handleUpdateTask = async (updatedTask) => {
    ...
    const base = (import.meta.env.VITE_API_URL || "http://localhost:5000/api/auth").replace("/auth", "");
    try {
      await fetch(`${base}/tasks/${updatedTask.id}`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
  ...
  const handleAddMember = () => {
    alert("Only admins can add team members. Ask your admin to add this person from the Admin Dashboard.");
  };

  const handleUpdateMember = () => {
    alert("Only admins can edit team member details.");
  };
  ...
  const handleUploadDocument = async (newDoc) => {
    ...
    } catch (e) { console.error("Error uploading document:", e); }
  };
  ...
  const handleCreateFolder = async (newFolder) => {
    ...
    try {
      await fetch(`${base}/documents`, {
        method: "POST",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
        body: JSON.stringify({ ...newFolder, type: "Folder", size: "-" })
      });
      syncDashboardData();
      triggerNotification(
        "Folder Created",
  ...
  const handleDeleteDocument = async (docId) => {
    ...
    const base = (import.meta.env.VITE_API_URL || "http://localhost:5000/api/auth").replace("/auth", "");
    try {
      await fetch(`${base}/documents/${docId}`, {
        method: "DELETE",
        headers: { Authorization: `Bearer ${token}` }
      });
      syncDashboardData();
  ...
  const handleUpdateDocument = async (updatedDoc) => {
    ...
    const base = (import.meta.env.VITE_API_URL || "http://localhost:5000/api/auth").replace("/auth", "");
    try {
      await fetch(`${base}/documents/${updatedDoc.id}`, {
        method: "PATCH",
        headers: { "Content-Type": "application/json", Authorization: `Bearer ${token}` },
      ...
      <div className={`crm-dashboard-layout ${sidebarCollapsed ? "collapsed-sidebar" : ""} ${mobileSidebarActive ? "mobile-sidebar-active" : ""}`}>
        ...
        <header className="crm-top-navbar" style={{ height: "72px", borderBottom: "1px solid var(--crm-border)", boxShadow: "0 1px 3px rgba(15,23,42,0.05)", background: "var(--crm-card)" }}>
          <div className="brand-section" style={{ display: "flex", alignItems: "center", gap: "16px", paddingLeft: "24px" }}>
            ...
            <span style={{ fontSize: "24px", fontWeight: "700", display: "flex", alignItems: "center", lineHeight: 1, letterSpacing: "-0.02em" }}>
          ...
          <div className="nav-right-controls" style={{ display: "flex", alignItems: "center", gap: "16px", paddingRight: "24px" }}>
            ...
            <div className="profile-trigger" onClick={() => setShowProfileMenu(!showProfileMenu)} style={{ display: "flex", alignItems: "center", gap: "10px", cursor: "pointer", height: "40px" }}>
              ...
              <div className="profile-name-text d-none d-lg-block" style={{ fontSize: "12.5px", fontWeight: "700", color: "var(--crm-dark)" }}>
        ...
        <main className="crm-viewport-content">
          ...
          {activeMenu !== "dashboard" && activeMenu !== "me" && activeMenu !== "news" && activeMenu !== "settings" && activeMenu !== "calendar" && activeMenu !== "tasks" && activeMenu !== "team" && activeMenu !== "notifications" && activeMenu !== "documents" && activeMenu !== "orgchart" && activeMenu !== "chat" && (
